...
- immediate goal: maintain the completed rebuild baseline and capture only newly discovered non-blocking parity, documentation, or packaging follow-up work without reopening completed wave gates
