...
| `packages/happy-app/sources/types/**` | app-local TypeScript type helpers | `packages/vibe-app` | imported type tree | done | app-local type ownership stays inside the imported package unless promoted deliberately |
