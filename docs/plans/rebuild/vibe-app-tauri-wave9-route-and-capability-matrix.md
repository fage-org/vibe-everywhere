...
| `/(app)/friends/**` | `P2` | desktop, Android, web export | `/root/happy/packages/happy-app/sources/app/(app)/friends/**` | `secondary-routes-and-social` | `secondary-routes-and-social` | `secondary-routes-and-social` | explicitly deferred from the current promotion gate until desktop/social value is confirmed |
