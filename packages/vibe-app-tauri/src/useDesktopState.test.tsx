...
vi.mock("./desktop-client", async () => {
  const actual = await vi.importActual<typeof import("./desktop-client")>("./desktop-client");
  return {
    ...actual,
...
type HookState = ReturnType<typeof useDesktopState>;
...
function HookProbe({
  ...
  onValue(useDesktopState(activeSessionId));
  return null;
}
