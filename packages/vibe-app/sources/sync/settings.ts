...
export const SettingsSchema = z.object({
    ...
    voiceCustomAgentId: z.string().nullable().describe('Custom ElevenLabs agent ID (null to use Vibe default)'),
    voiceBypassToken: z.boolean().describe('Bypass Vibe server token and connect directly to ElevenLabs (requires custom agent ID)'),
